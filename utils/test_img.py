...
def test(img_path):
    model = create_model()      #must create the model then load weights.   #if i have saved the model instead of save_weights--> then can I nglect this step of creating the model, and load it directly
